...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    let stack = CoreDataStack(modelName: "NoteModel")!
    ...
    func sandboxPlayground() {
        ...
        // write
        do {
            try "Hello there!".writeToURL(url!, atomically: true, encoding: NSUTF8StringEncoding)
        } catch {
            print("ehh somethings wrong")
        }
